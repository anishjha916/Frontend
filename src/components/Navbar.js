...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#D9D9D9', height: '80px', width: '1100px', marginLeft: '150px', borderRadius: '30px', position: 'fixed', top: 5, left: 0, right: 0, zIndex: 1000, opacity: '0.9' }}>
